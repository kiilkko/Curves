// Curves.cpp: определ€ет точку входа дл€ консольного приложени€.
//
#include "stdafx.h"
#include <vector>
#include <algorithm>
...
int main()
{
	...
	//¬ывод точек дл€ t=PI/4, t вводитс€ в радианах, t=0.785 рад
	...
	//проверим адрес, на который указывают в пам€ти указатели в первом и втором контейнере (должны указывать на один объект)
	//если два указател€ указывают на один объект, выведем его тип и адрес
	...
	//—ортировка второго контейнера по радиусу
	struct CompareSh
	{
	...
	if (SecondContainer.size() > 0)
	{
		...
		//ѕодсчет радиусов во втором контейнере
